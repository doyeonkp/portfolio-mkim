package com.mkim.portfolio.domain

import com.mkim.portfolio.domain.constant.SkillType
import com.mkim.portfolio.domain.entity.*
import com.mkim.portfolio.domain.repository.*
...
class DataInitializer(
    ...
    @PostConstruct
    fun initializeData() {
        println("Spring is started, now initialize the data set.")

        val achievements = mutableListOf<Achievement>(
            Achievement(
                title = "2022 Carkao 헤커톤 최우수상",
                description = "고양이 쇼핑몰 검색 서비스의 아키텍쳐, 데이터 모델, API 개발 역할 수행",
                host = "캣카오",
        ...
        val experience2 = Experience(
            title = "주식회사 캣카오(Catkao Corp.)", description = "소셜서비스팀 백엔드 개발자", startYear = 2022,
            startMonth = 9,
            endYear = null,
            endMonth = null,
            isActive = true,
